...
def start_new_igor_object(line_number: int, line: str, stripped_line: str) -> Tuple[IgorObject, str]:
    """
...
def end_current_igor_object(igor_object_data: IgorObject, end_line: int, filename: str) -> IgorObject:
    """
